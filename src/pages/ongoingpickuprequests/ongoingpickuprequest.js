...
export const OnGoingPickupRequest  =()=>{
        ...
        <table className="styled-table">
          ...
          <tbody>
            {pickuprequests.map((pickuprequest) => {
              if (pickuprequest.Status !== "Pickup Requested" && pickuprequest.Status !== "Trip Ended"  && pickuprequest.FleetName !== undefined) {
                return (
